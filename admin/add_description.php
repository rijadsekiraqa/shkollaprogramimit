                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        if($description->create()){
                            $session->message("Pershkrimi u shtua me sukses");
                                header("Location: view_descriptions.php");
                        }
                        }
                        ?>
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Shto Sherbim</a></li>
                            </ul>
                                                    ...
                                                    <form action="#" method="post" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick addlibrary" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                <textarea class="form-control" placeholder="Shkruaj paragrafin" name="paragraph" style="height: 100px"></textarea>
                                                                </div>
                                                                <input class="btn btn-primary waves-effect waves-light" id="login" value="Shto" type="submit" name="add_description"/>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
