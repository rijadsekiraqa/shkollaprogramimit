            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        if($user->update()){
                            $session->message("Perdoruesi u modifikua me sukses");
                            header("Location: view_users.php"); 
                        }
                        }
                        ?>
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#reviews">Perditeso Perdoruesin</a></li>
                            </ul>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="devit-card-custom">
                                                            ...
                                                            <input class="btn btn-primary waves-effect waves-light" id="login" value="Perditeso" type="submit" name="edit_user"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
